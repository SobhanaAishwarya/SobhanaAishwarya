...
<p>
  <a href="https://www.linkedin.com/in/sobhana-aishwarya-kantapalli-620aa62a3/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
  <a href="mailto:aishwaryasobhana@gmail.com"><img src="https://img.shields.io/badge/Email-1f2937?style=flat-square&logo=gmail&logoColor=white" alt="Email"/></a>
  <a href="https://leetcode.com/u/uBWGyJQ6xD/"><img src="https://img.shields.io/badge/LeetCode-1f2937?style=flat-square&logo=leetcode&logoColor=FFA116" alt="LeetCode"/></a>
  <a href="https://www.hackerrank.com/profile/aishwaryasobhana"><img src="https://img.shields.io/badge/HackerRank-1f2937?style=flat-square&logo=hackerrank&logoColor=2EC866" alt="HackerRank"/></a>
</p>
...
I'm a Computer Science undergraduate at **ANITS, Visakhapatnam** (CGPA 9.3, graduating 2027).
My work sits where data science meets product: I like taking a model out of the notebook and
giving it an interface, a data pipeline and sensible failure behaviour.
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      Five-agent pipeline that interviews a citizen with adaptive questions, checks 14 central-government schemes with a deterministic rules engine, flags near-misses and builds a document checklist.<br/><br/>
      <sub>Python · Streamlit · rules engine · optional LLM explanations · 31 unit tests</sub><br/>
      <sub>Capabl National Agentic AI Hackathon</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      Emergency blood-matching web app that contacts the nearest <i>eligible</i> donors first, widens the search ring by ring, and keeps contact details private until a donor accepts.<br/><br/>
      <sub>Flask · SQLAlchemy · JWT · vanilla JavaScript</sub>
    </td>
  </tr>
</table>
...
| **Data & ML** | Pandas · NumPy · Scikit-learn · imbalanced-learn · TensorFlow · Matplotlib · Seaborn · Plotly |
| **AI / NLP** | RAG · Sentence Transformers · FAISS · LangChain text splitters · semantic search · OpenRouter LLM APIs |
| **Apps & APIs** | Streamlit · Flask · FastAPI · React · SQLAlchemy |
| **Data stores** | SQLite · PostgreSQL · Redis |
| **Tooling** | Git & GitHub · Jupyter · VS Code · GitHub Actions · Docker · Render |
